...
var DefaultMaxDynamicBaseFeeUpwardAdjustment = sdk.NewDecWithPrec(10000, 4) // 100%
var DefaultMaxDynamicBaseFeeDownwardAdjustment = sdk.ZeroDec()
var DefaultTargetGasUsedPerBlock = uint64(1)        // 1
