...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.3.36-0.20241105154804-ec0638bf88b9
	...
	github.com/tendermint/tendermint => github.com/sei-protocol/sei-tendermint v0.5.80-block-sync
